...
%\special{pdf:mapline rml H fonts-japanese-mincho.ttf}
% \special{pdf:mapline gbm H NotoSerifJP-Bold.ttf}
%英字フォント
...
\input{file/linear_regression}
%\input{file/supervised_ML}
%\input{file/back_propagation}
%\input{file/entropy_information}
%\input{file/stochastic_process}
% \input{file/boltzmanML}
%\input{file/stable-diffusion}
% \input{file/review}
%\input{file/convex.tex}
